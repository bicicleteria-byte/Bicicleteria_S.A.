...
// Métricas
$sql_total = "SELECT COUNT(*) AS total FROM proveedor";
$sql_disponibles = "SELECT COUNT(*) AS disponibles FROM proveedor WHERE estado='Disponible'";

$total = mysqli_fetch_assoc(mysqli_query($conexion, $sql_total))['total'];
$disponibles = mysqli_fetch_assoc(mysqli_query($conexion, $sql_disponibles))['disponibles'];
...
<aside class="sidebar">
  ...
  <a href="gestionar_proveedores.php" class="nav-item active">
  ...
  <div class="stats">
    ...
    <div class="stat-card">
      <div class="stat-label">
        <i class="ti ti-truck"></i> Total proveedores
      </div>
      <div class="stat-val">
        <?php echo $total; ?>
      </div>
    ...
    <div class="stat-card">
      <div class="stat-label">
        <i class="ti ti-check"></i> Disponibles
      </div>
      <div class="stat-val">
  ...
  <div class="tabla-wrap">
    ...
    <div class="tabla-header">
      ...
      <form class="search-form" method="GET" action="">
        ...
        <?php if($buscar): ?>
          <a href="gestionar_proveedores.php" class="btn-editar" style="border-color:#E5E7EB">
      ...
      <?php if(mysqli_num_rows($resultado) === 0): ?>
        ...
        <tr class="empty-row">
          <td colspan="7">
            ...
            No se encontraron proveedores<?php echo $buscar ? " para \"$buscar\"" : ''; ?>
          </td>
        </tr>
      ...
      <?php else: ?>
        ...
        <?php while($fila = mysqli_fetch_assoc($resultado)): ?>
          ...
          <tr>
            ...
            <td class="id-cell">
              #<?php echo str_pad($fila['id_proveedor'], 3, '0', STR_PAD_LEFT); ?>
            </td>
            ...
            <td>
              ...
              <div class="actions">
                ...
                <a href="editar_proveedor.php?id=<?php echo $fila['id_proveedor']; ?>" class="btn-editar">
                  <i class="ti ti-edit"></i>
                  Editar
                </a>

                <a
                  href="eliminar_proveedor.php?id=<?php echo $fila['id_proveedor']; ?>"
                  class="btn-eliminar"

...
<aside class="sidebar">
 <div class="sidebar-brand">
    <img src="../Imagenes/logobici.png" width="40">
    <span>Bicicletería S.A</span>
</div>
 
  <a href="panel.php" class="nav-item"><i class="ti ti-layout-dashboard"></i><span>Inicio</span></a>
  <a href="gestionar_productos.php" class="nav-item active"><i class="ti ti-package"></i><span>Productos</span></a>
  <div class="nav-spacer"></div>
  <a href="../menucrud.php" class="nav-item logout"><i class="ti ti-arrow-left"></i><span>Volver al sitio</span></a>
</aside>

...
$sql = $buscar
    ? "SELECT * FROM venta
       WHERE id_venta LIKE '%$buscar%'
       OR metodo_pago LIKE '%$buscar%'
...
<aside class="sidebar">
  ...
  <a href="gestionar_ventas.php" class="nav-item active">
...
<main class="main">
  ...
  <div class="topbar">
    ...
    <a href="agregar_venta.php" class="btn-agregar">
  ...
  <div class="tabla-wrap">
    ...
    <div class="tabla-header">
      ...
      <form class="search-form" method="GET">
        ...
        <?php if($buscar): ?>
          <a href="gestionar_ventas.php" class="btn-editar" style="border-color:#E5E7EB">
      ...
      <?php else: ?>
        ...
        <?php while($fila = mysqli_fetch_assoc($resultado)): ?>
          ...
          <tr>
            ...
            <td class="id-cell">
              #<?php echo str_pad($fila['id_venta'], 3, '0', STR_PAD_LEFT); ?>
            </td>
            ...
            <td>
              <?php echo htmlspecialchars($fila['metodo_pago']); ?>
            </td>
            ...
            <td>
              ...
              <div class="actions">
                ...
                <a href="editar_venta.php?id=<?php echo $fila['id_venta']; ?>" class="btn-editar">
                  <i class="ti ti-edit"></i>
                  Editar
                </a>

                <a
                  href="eliminar_venta.php?id=<?php echo $fila['id_venta']; ?>"
                  class="btn-eliminar"

...
<head>
  ...
  <title>Gestionar empleados — Bicicleteria SA</title>
...
<main class="main">
  ...
  <div class="topbar">
    ...
    <a href="agregar_empleado.php" class="btn-agregar">
  ...
  <div class="stats">
    <div class="stat-card">
      <div class="stat-label">
        <i class="ti ti-users"></i> Total empleados
      </div>
      <div class="stat-val">
        <?php echo $total; ?>
      </div>
  ...
  <div class="tabla-wrap">
    ...
    <div class="tabla-header">
      ...
      <form class="search-form" method="GET" action="">
        ...
        <?php if($buscar): ?>
          <a href="gestionar_empleados.php"
             class="btn-editar"
        ...
        <?php else: ?>
          ...
          <?php while($fila = mysqli_fetch_assoc($resultado)): ?>
            ...
            <tr>
              ...
              <td class="id-cell">
                #<?php echo str_pad($fila['id_empleado'], 3, '0', STR_PAD_LEFT); ?>
              </td>
              ...
              <td>
                <div class="actions">
                  ...
                  <a href="editar_empleado.php?id=<?php echo $fila['id_empleado']; ?>"
                     class="btn-editar">
                    <i class="ti ti-edit"></i>
                    Editar
                  </a>

                  <a href="eliminar_empleado.php?id=<?php echo $fila['id_empleado']; ?>"
                     class="btn-eliminar"
                     onclick="return confirm('¿Eliminar a <?php echo htmlspecialchars($fila['nombre']); ?>?')">

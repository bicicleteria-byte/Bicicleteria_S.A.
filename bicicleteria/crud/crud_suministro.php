...
// Contar registros
$sql_total = "SELECT COUNT(*) AS total FROM detalle_suministro";
...
$sql = $buscar
    ? "SELECT * FROM detalle_suministro
       WHERE id_det_sumin LIKE '%$buscar%'
       OR detalles LIKE '%$buscar%'
       OR id_producto LIKE '%$buscar%'
...
<head>
    <meta charset="UTF-8">
    <title>Gestionar Suministros</title>
...
<aside class="sidebar">
  ...
  <a href="crud_suministro.php" class="nav-item active">
...
<main class="main">
  ...
  <!-- Topbar -->
  <div class="topbar">
    <h1>Gestionar Suministros</h1>

    <a href="agregar_suministro.php" class="btn-agregar">
      <i class="ti ti-plus"></i> Nuevo suministro
    </a>
  </div>
  ...
  <div class="stats">
    ...
    <div class="stat-card">
      <div class="stat-label">
        <i class="ti ti-package"></i> Total suministros
      </div>
  ...
  <div class="tabla-wrap">
    ...
    <div class="tabla-header">
      ...
      <form class="search-form" method="GET">
        ...
        <?php if($buscar): ?>
          <a href="crud_suministro.php" class="btn-editar" style="border-color:#E5E7EB">
      ...
      <?php else: ?>
        ...
        <?php while($fila = mysqli_fetch_assoc($resultado)): ?>
          ...
          <tr>
            ...
            <td class="id-cell">
              #<?php echo str_pad($fila['id_det_sumin'], 3, '0', STR_PAD_LEFT); ?>
            </td>

            <td>
              <?php echo htmlspecialchars($fila['detalles']); ?>
            </td>
            ...
            <td>
              ...
              <div class="actions">
                ...
                <a href="editar_suministro.php?id=<?php echo $fila['id_det_sumin']; ?>" class="btn-editar">
                  <i class="ti ti-edit"></i>
                  Editar
                </a>

                <a
                  href="eliminar_suministro.php?id=<?php echo $fila['id_det_sumin']; ?>"
                  class="btn-eliminar"

 ...
 <section class="registro">
  <div class="registro-contenedor">
    <div class="registro-texto">
      <span class="seccion-eyebrow">Crear cuenta</span>
      <h2>Regístrate</h2>
      ...
      <ul class="registro-beneficios">
        ...
        <li>🚚 <strong>Envíos rápidos</strong> y seguimiento personalizado</li>
        <li>🚲 <strong>Acceso anticipado</strong> a nuevos lanzamientos</li>
      </ul>
    </div>

    <div class="registro-formulario">
      <h2>Crea tu cuenta</h2>
      <p class="subtitulo">Completa tus datos para empezar</p>
      <form method="POST">
